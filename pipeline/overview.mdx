---
title: "BDB-Genomics ATAC-seq Pipeline Architecture Overview"
sidebarTitle: "Overview"
description: "End-to-end ATAC-seq framework covering all six pipeline stages, modality switching, lifecycle hooks, and the full output directory structure."
---
