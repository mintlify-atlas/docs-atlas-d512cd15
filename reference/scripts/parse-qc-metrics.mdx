...
description: "Complete CLI reference for parse_qc_metrics.py — the script that evaluates FRiP, TSS enrichment, mapping rate, and duplicate rate and writes pass/fail trigger files."
---
