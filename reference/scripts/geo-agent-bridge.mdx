...
description: "CLI reference for geo_agent_bridge.py — bridges GEOAgent/bioStream ATAC-seq metadata CSVs to a BDB pipeline-ready config and sample sheet, with optional SRA download."
---
...
```bash
python3 rules/scripts/geo_agent_bridge.py <csv_path> [--download]
```
