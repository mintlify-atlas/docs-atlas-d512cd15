---
title: "validate_config.py: Pipeline Config Validation Reference"
sidebarTitle: "validate-config"
description: "CLI reference for validate_config.py — validates config.yaml schema, reference paths, sample sheet integrity, and Conda environments before DAG builds."
---
