---
title: "Snakemake Execution Profiles: Local, HPC, and Cloud"
sidebarTitle: "Profiles"
description: "Reference for all 8 Snakemake execution profiles: local, SLURM, low-resource, test, AWS Batch, GCP Life Sciences, Azure Batch, and Kubernetes."
---
