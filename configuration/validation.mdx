---
title: "Config Validation: validate_config.py Reference"
...
The validator executes seven distinct checks in sequence. All errors are accumulated across every stage and printed together — the run does not stop at the first error.
